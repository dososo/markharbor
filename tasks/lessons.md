...
- 2026-05-17：采集计数必须区分“列表发现”和“详情增强完成”。`已采集` 这类文案会让用户误以为正文和图片已经完整抓取；UI 应明确显示“已发现”和“详情完成”两个阶段。
...
- 2026-05-17：开源仓库文档要保持产品文档语气，不放个人口吻推广内容。仓库内只保留正式产品说明、安装说明、发布链接和素材清单。
